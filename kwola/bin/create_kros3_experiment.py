...
def main():
    ...
    configDir = KwolaCoreConfiguration.createNewLocalKwolaConfigDir("standard_experiment",
                                                                    ...
                                                                    neural_network_batch_size=24,
                                                                    neural_network_batches_per_iteration=4,
                                                                    ...
                                                                    training_cache_full_batch_prep_workers=8,
                                                                    training_initial_batch_prep_workers=8,
                                                                    training_max_batch_prep_workers=8,
                                                                    training_precompute_batches_count=24,
                                                                    training_reset_workers_every_n_batches=10000,
